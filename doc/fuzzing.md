...
The project's collection of seed corpora is found in the [`burritocoin-core/qa-assets`](https://github.com/BurritoCoinDev/qa-assets) repo.

To fuzz `process_message` using the [`burritocoin-core/qa-assets`](https://github.com/BurritoCoinDev/qa-assets) seed corpus:

```sh
$ git clone https://github.com/BurritoCoinDev/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`burritocoin-core/qa-assets`](https://github.com/BurritoCoinDev/qa-assets) repo.

Every single pull request submitted against the BurritoCoin Core repo is automatically tested against all inputs in the [`burritocoin-core/qa-assets`](https://github.com/BurritoCoinDev/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make BurritoCoin Core more robust.
