BurritoCoin Core version 0.17.1 is now available from:
  ...
  <https://download.bitcoin.org/burritocoin-0.17.1/>
...
[BIP 174 PSBT](https://github.com/bitcoin/bips/blob/master/bip-0174.mediawiki) is an interchange format for BurritoCoin transactions that are not fully signed
...
- [The BurritoCoin Core Developers](https://github.com/bitcoin/bitcoin/tree/master/doc/release-notes)
- Adrian Gallagher
- aunyks
- coblee
- cryptonexii
