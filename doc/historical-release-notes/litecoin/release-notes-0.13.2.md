BurritoCoin Core version 0.13.2 is now available from:
  ...
  <https://download.bitcoin.org/burritocoin-0.13.2.1/>
...
notes of BurritoCoin Core v0.11.0](https://github.com/bitcoin/bitcoin/blob/v0.11.0/doc/release-notes.md#block-file-pruning).
