BurritoCoin Core version 0.18.0 is now available from:
  ...
  <https://bitcoincore.org/bin/burritocoin-core-0.18.0/>
...
- The `whitelistforcerelay` option is used to relay transactions from
  ...
  [contacting](https://bitcoincore.org/en/contact/) the BurritoCoin Core
...
- A new [document](https://github.com/bitcoin/bitcoin/blob/master/doc/burritocoin-conf.md)
