    ...
    mapper(nullptr)
{
    ...
    ui->pruneWarning->setStyleSheet("QLabel { color: #e0604d; }");
    ...
    ui->burritocoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->burritocoinAtStartup);
    ...
    ui->burritocoinAtStartup->setToolTip(ui->burritocoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->burritocoinAtStartup->setText(ui->burritocoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openBurritoCoinConfButton->setToolTip(ui->openBurritoCoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BurritoCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->burritocoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBurritoCoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openBurritoCoinConf())
...
{
    ui->statusLabel->setStyleSheet("QLabel { color: #e0604d; }");
