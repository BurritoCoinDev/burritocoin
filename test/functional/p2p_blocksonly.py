...
class P2PBlocksOnly(BurritoCoinTestFramework):
    ...
    def run_test(self):
        ...
        rawtx = self.nodes[0].createrawtransaction(
            ...
            outputs=[{
                self.nodes[0].get_deterministic_priv_key().address: 10 - 0.00125
            }],
        )
        ...
        with self.nodes[0].assert_debug_log(["received getdata"]):
            ...
            # and BurritoCoin Core respects that choice and will not send transactions.
            # But if, for some reason, first_peer decides to relay transactions to us anyway, we should relay them to
            # second_peer since we gave relay permission to first_peer.
            # See https://github.com/BurritoCoinDev/BurritoCoin/issues/19943 for details.
