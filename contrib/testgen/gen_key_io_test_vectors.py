...
bech32_templates = [
  ...
  ('brto',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('brto',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('brto',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('brto',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tbrto',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tbrto',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tbrto',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tbrto',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('rbrto',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rbrto',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rbrto',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rbrto', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tbrto',   17, 32, Encoding.BECH32M, False, False, False),
  ('rbrto',  3,  1, Encoding.BECH32M, False, False, False),
  ('brto',   15, 41, Encoding.BECH32M, False, False, False),
  ('tbrto',    0, 16, Encoding.BECH32,  False, False, False),
  ('rbrto',  0, 32, Encoding.BECH32,  True,  False, False),
  ('brto',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tbrto',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rbrto',  0, 20, Encoding.BECH32,  False, False, True),
  ('brto',    0, 20, Encoding.BECH32M, False, False, False),
  ('tbrto',    0, 32, Encoding.BECH32M, False, False, False),
  ('rbrto',  0, 20, Encoding.BECH32M, False, False, False),
  ('brto',    1, 32, Encoding.BECH32,  False, False, False),
  ('tbrto',    2, 16, Encoding.BECH32,  False, False, False),
  ('rbrto', 16, 20, Encoding.BECH32,  False, False, False),
]
